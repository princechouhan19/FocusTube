...
(function () {
  ...
  function hideBannerAds() {
    ...
    const promotedVideos = document.querySelectorAll(
      AD_SELECTORS.promotedVideo + ", " + AD_SELECTORS.inFeedAd,
    );
    ...
    const sidebarAds = document.querySelectorAll(
      AD_SELECTORS.sidebarAd + ", " + AD_SELECTORS.companionAd,
    );
  ...
  function skipVideoAds() {
    ...
    skipInterval = setInterval(() => {
      ...
      const isAd =
        document.querySelector(AD_SELECTORS.videoAd) ||
        ...
        const skipButton =
          document.querySelector(AD_SELECTORS.skipButton) ||
  ...
  function showAdWarning() {
    ...
    const warning = createElement("div", {
      ...
      innerHTML:
        "⚠️ <strong>Ad Detected:</strong> Skipping not available. Playing at 16x speed with audio muted. This may trigger YouTube's ad-block detection.",
    });
